...
export default function WeatherApp() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 flex items-center justify-center p-4">
      ...
      <footer className="bg-gray-700 flex-col gap-5 text-white py-6 flex items-center justify-center">
        <h1 className="font-bold bg-gray-300 text-black text-2xl p-3 rounded-md">
          Weather API
        </h1>
        <div className="flex gap-3 flex-wrap">
          <p className="bg-gray-200 text-gray-900 font-bold p-2 rounded-md">
            Eviota, Jhun Jay Mars
          </p>
          <p className="bg-gray-200 text-gray-900 font-bold p-2 rounded-md">
            Helera, Rommel
          </p>
